...
int32_t cavc_plinelist_create(uint32_t capacity, const cavc_plinelist **plinelist);
...
int32_t cavc_plinelist_push(cavc_plinelist *plinelist,
                            cavc_pline *pline);
...
/// `plinelist` must be null or a valid [cavc_plinelist] object.
/// `pline` must point to a valid place in memory to be written.
int32_t cavc_plinelist_pop(cavc_plinelist *plinelist, const cavc_pline **pline);
...
/// `plinelist` must be null or a valid [cavc_plinelist] object.
/// `pline` must point to a valid place in memory to be written.
int32_t cavc_plinelist_take(cavc_plinelist *plinelist, uint32_t position, const cavc_pline **pline);
...
int32_t cavc_shape_create(const cavc_plinelist *plinelist, const cavc_shape **shape);
